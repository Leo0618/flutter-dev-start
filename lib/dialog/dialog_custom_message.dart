...
class CustomMessageDialog extends Dialog {
  String title;
  String message;
  String negativeText;
  String positiveText;
  Function onCloseTitleButton;
  Function onCloseNegative;
  Function onClosePositive;
  ...
  CustomMessageDialog({
    ...
    this.negativeText,
    this.positiveText,
    this.onCloseTitleButton,
    this.onClosePositive,
    @required this.onCloseNegative,
  }) : super(key: key);
  ...
  Widget _buildBottomCancelButton(BuildContext context) {
    return new Flexible(
      ...
      child: new MaterialButton(
        onPressed: this.onCloseNegative,
        child: new Text(
          negativeText,
          style: TextStyle(
            fontSize: 16.0,
